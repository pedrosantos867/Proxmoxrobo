...
<!-- JQuery toast notifications: https://github.com/kamranahmedse/jquery-toast-plugin -->
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand hidden-xs hidden-sm" href="<?= $_->link('') ?>">
                <img style="max-width:167px; margin-top: -10px;" src="<?= $_->path('img/logo.png') ?>">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li <?= ($_->link($request) == $_->link('bills') ? 'class="active"' : '') ?>>
                    <a href="<?= $_->link('bills') ?>"><span class="glyphicon glyphicon-book" aria-hidden="true"></span>
                ...
                <li <?= ($_->link($request) == $_->link('orders') ? 'class="active"' : '') ?>>
                    <a href="" class="dropdown-toggle" data-toggle="dropdown"><span
                            class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> <span
                            class="hidden-sm"><?= $_->l('Заказы') ?></span> <span class="caret"></span></a>
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li>
                            <a href="<?= $item->link ?>"><span class="fa <?= $item->icon ?>" aria-hidden="true"></span>
                                &nbsp;<?= $item->name ?>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="<?= $_->link('service-orders/category-'.$category->id) ?>"><span
                                    class="fa <?= $category->icon ?>" aria-hidden="true"></span>
                                &nbsp;<?= $category->name ?>
                            </a>
                        </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li <?= ($_->link($request) == $_->link('domain-orders/order') ? 'class="active"' : '') ?>>
                            <a href="<?= $_->link('domain-orders/order') ?>"><span class="glyphicon glyphicon-globe"
                                    aria-hidden="true"></span>
                                &nbsp;<?= $_->l('Домен') ?>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="<?= $_->link('service-order/category-'.$category->id) ?>"><span
                                    class="fa <?= $category->icon ?>" aria-hidden="true"></span>
                                &nbsp;<?= $category->name ?>
                            </a>
                        </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li>
                            <a
                                href="<?= $_->link('currency/set/' . $c->id . '?back=' . $request) ?>"><?= $c->name ?></a>
                        </li>
                        <? } ?>
                    </ul>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li>
                            <a href="<?= $_->link($request, 'lang='.$l->id) ?>">
                                <img src="<?=$_->link('storage/i18n/flags/'.$l->iso_code.'.png')?>" height="23px">
                                <?=$l->name?>
                            </a>
                        </li>
                        <? } ?>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><span
                            class="glyphicon glyphicon-user"></span> <?= $client->username ?>
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">

                        <li><a href="<?= $_->link('setting') ?>"> <span class="glyphicon glyphicon-cog"></span>
                                <?= $_->l('Настройки') ?></a></li>
                        <? if ($config->refprogram_enable) { ?>
                        <li><a href="<?= $_->link('partner') ?>"> <span class="glyphicon glyphicon-briefcase"></span>
                                <?= $_->l('Партнерская программа') ?>
                            </a></li>
                        <? } ?>
                        <li><a href="<?= $_->link('logout') ?>"> <span class="glyphicon glyphicon-log-out"></span>
                                <?= $_->l('Выход') ?></a></li>
                    </ul>
                </li>
