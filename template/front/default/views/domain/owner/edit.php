                    ...
                    <form action="<?= $_->link($request) ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select class="form-control" name="country" data-validate="required" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                    <?foreach($countryList as $code=>$name){?>
                                        <option value="<?=$code?>" <?=($owner->country == $code ? 'selected="selected"' : '')?>><?=$name?></option>
                                    <?}?>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <select class="form-control "  name="type" data-validate="required" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                    <option value="1" <?=($owner->type == '1' ? 'selected="selected"' : '')?>><?=$_->l('Частное лицо')?></option>
                                    <option value="2" <?=($owner->type == '2' ? 'selected="selected"' : '')?>><?=$_->l('Юридическое лицо')?></option>
                                </select>
                            </div>
                        </div>
                        <?if(!$disable_edit){ ?>
...
<?}?>
                        <div class="organization-inputs ru">
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_name_ru" data-validate="custom"
                                           data-validate-match="(.{3,})" data-validate-message-fail-custom="<?=$_->l('Например: ООО Биллинг-системы')?>"
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_address_ru" data-validate="custom"
                                           data-validate-match="(.{3,})" data-validate-message-fail-custom="<?=$_->l('Введите адрес, например: ул. Пушкина, дом 21Г, кв. 1')?>"
                                           value="<?= $owner->address ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Почтовый адрес')?></label>
                                    <input type="text" class="form-control" name="organization_postal_address_ru" data-validate="custom"
                                           data-validate-match="(.{3,})" data-validate-message-fail-custom="<?=$_->l('Введите адрес, например: ул. Пушкина, дом 21Г, кв. 1')?>"
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_inn_ru" data-validate="required"
                                           value="<?= $owner->organization_inn ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('КПП')?></label>
                                    <input type="text" class="form-control" name="organization_edrpou_ru" data-validate="custom" data-validate-match="^([\d]{9}|-)$"
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_ogrn_ru" data-validate="custom" data-validate-match="^([\d]{13}([\d]{2})?|-)$"
                                           value="<?= $owner->organization_ogrn ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('БИК')?></label>
                                    <input type="text" class="form-control" name="organization_mfo_ru" data-validate="custom" data-validate="^(\d{8,9}|-)$"
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_bank_ru" data-validate="required"
                                           value="<?= $owner->organization_bank ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Рассчетный счет')?></label>
                                    <input type="text" class="form-control" name="organization_rs_ru" data-validate="custom" data-validate-match="^(\d{20}|-)$"
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_fax_ru" data-validate="phone_new"
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_email_ru" data-validate="email"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_phone_ru" data-validate="phone_new" data-inputmask="'alias': 'phone'"
                        ...
                        <div class="organization-inputs by">
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Название организации')?></label>
                                    <input type="text" class="form-control" name="organization_name_by" data-validate="custom"
                                           data-validate-match="(.{3,})" data-validate-message-fail-custom="<?=$_->l('Например: ООО Биллинг-системы')?>"
                                           value="<?= $owner->organization_name ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Юридический адрес')?></label>
                                    <input type="text" class="form-control" name="organization_address_by" data-validate="custom"
                                           data-validate-match="(.{3,})" data-validate-message-fail-custom="<?=$_->l('Введите адрес, например: ул. Пушкина, дом 21Г, кв. 1')?>"
                                           value="<?= $owner->address ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Почтовый адрес')?></label>
                                    <input type="text" class="form-control" name="organization_postal_address_by" data-validate="custom"
                                           data-validate-match="(.{3,})" data-validate-message-fail-custom="<?=$_->l('Введите адрес, например: ул. Пушкина, дом 21Г, кв. 1')?>"
                                           value="<?= $owner->organization_postal_address ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_inn_by" data-validate="required"
                                           value="<?= $owner->organization_inn ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('БИК')?></label>
                                    <input type="text" class="form-control" name="organization_mfo_by" data-validate="custom" data-validate="^(\d{8,9}|-)$"
                                           value="<?= $owner->organization_mfo ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Банк')?></label>
                                    <input type="text" class="form-control" name="organization_bank_by" data-validate="required"
                                           value="<?= $owner->organization_bank ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Рассчетный счет')?></label>
                                    <input type="text" class="form-control" name="organization_rs_by" data-validate="custom" data-validate-match="^(\d{3,20}|-)$"
                                           value="<?= $owner->organization_rs ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_fax_by" data-validate="phone_new"
                                           data-validate-allow-empty="1" data-inputmask="'alias': 'phone'"
                                           value="<?= $owner->fax ?>" <?= ($owner->fax && $disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('E-mail')?></label>
                                    <input type="text" class="form-control" name="organization_email_by" data-validate="email"
                                           value="<?= $owner->email ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Телефон')?></label>
                                    <input type="text" class="form-control" name="organization_phone_by" data-validate="phone_new" data-inputmask="'alias': 'phone'"
                                           value="<?= $owner->phone ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="organization-inputs ua">
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Название организации')?></label>
                                    <input type="text" class="form-control" name="organization_name_ua" data-validate="custom"
                                           data-validate-match="(.{3,})" data-validate-message-fail-custom="<?=$_->l('Например: ООО Биллинг-системы')?>"
                                           value="<?= $owner->organization_name ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Юридический адрес')?></label>
                                    <input type="text" class="form-control" name="organization_address_ua" data-validate="custom"
                                           data-validate-match="(.{3,})" data-validate-message-fail-custom="<?=$_->l('Введите адрес, например: ул. Пушкина, дом 21Г, кв. 1')?>"
                                           value="<?= $owner->address ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Почтовый адрес')?></label>
                                    <input type="text" class="form-control" name="organization_postal_address_ua" data-validate="custom"
                                           data-validate-match="(.{3,})" data-validate-message-fail-custom="<?=$_->l('Введите адрес, например: ул. Пушкина, дом 21Г, кв. 1')?>"
                                           value="<?= $owner->organization_postal_address ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_edrpou_ua" data-validate="required"
                                           value="<?= $owner->organization_edrpou ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('ИНН')?> (ІПН)</label>
                                    <input type="text" class="form-control" name="organization_inn_ua" data-validate="required"
                                           value="<?= $owner->organization_inn ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="organization_mfo_ua" data-validate="custom" data-validate-match="^(\d{6})$"
                                           value="<?= $owner->organization_mfo ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Банк')?></label>
                                    <input type="text" class="form-control" name="organization_bank_ua" data-validate="required"
                                           value="<?= $owner->organization_bank ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group col-lg-12">
                                    <label for="exampleInputEmail1"><?=$_->l('Рассчетный счет')?></label>
                                    <input type="text" class="form-control" name="organization_rs_ua" data-validate="custom" data-validate-match="^(\d{3,30})$"
                                           value="<?= $owner->organization_rs ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Факс')?></label>
                                    <input type="text" class="form-control" name="organization_fax_ua" data-validate="phone_new"
                                           data-validate-allow-empty="1" data-inputmask="'alias': 'phone'"
                                           value="<?= $owner->fax ?>" <?= ($owner->fax && $disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('E-mail')?></label>
                                    <input type="text" class="form-control" name="organization_email_ua" data-validate="email"
                                           value="<?= $owner->email ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Индекс')?></label>
                                    <input type="text" class="form-control" data-inputmask="'mask': '#####'" name="organization_zip_code_ua" data-validate="required"
                                           value="<?= $owner->zip_code ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Телефон')?></label>
                                    <input type="text" class="form-control" name="organization_phone_ua" data-validate="phone_new" data-inputmask="'alias': 'phone'"
                                           value="<?= $owner->phone ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="person-inputs">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1"><?=$_->l('Телефон')?></label>
                                    <input type="text" class="form-control" name="phone" data-validate="phone_new" data-inputmask="'alias': 'phone'"
                                           value="<?= $owner->phone ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="birth_date" value="<?= date('d-m-Y', strtotime($owner->birth_date)) ?>"
                            ...
                            <div
                                class="row only-for only-for-ru only-for-by only-for-kz only-for-ua only-for-az only-for-am only-for-kg only-for-md">
                                <div class="form-group col-lg-6">
                                    ...
                                    <span
                                        class="help info-message"><?= $_->l('Заполнение необходимо для регистрации доменов в зоне .ru и .рф') ?></span>
                                </div>
                            ...
                            <div
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="passport_date"
                                           data-inputmask="'mask': 'd-m-y'"
                                           value="<?= $owner->passport_date ? date('d-m-Y', strtotime($owner->passport_date)) : '' ?>" <?= ($disable_edit ? 'disabled="disabled"' : '') ?>>
                                    <span
                                        class="help info-message"><?= $_->l('Заполнение необходимо для регистрации доменов в зоне .ru и .рф') ?></span>
                                </div>
