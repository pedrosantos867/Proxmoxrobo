{s}<?=$_->l('Напоминание об оплате счета')?>{/s}
                            ...
                            <table cellpadding="0" cellspacing="0" align="center" width="100%" border="0"
                                ...
                                <tr style="vertical-align: top">
                                    <td style="color:#B8B8C0;line-height:150%;text-align:left; vertical-align: top;padding-top: 0px;padding-right: 30px;padding-bottom: 10px;padding-left: 30px">
                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: left"><?= $_->l('Это напоминание о том, что Ваш хостинг аккаунт # %id будет заблокирован', array('id' => $account->id)) ?>
                                            <br>
                                            <?= $_->l('Осталось меньше %days {%days|%words} до блокировки хостинг аккаунта.',
                                                array('days' => $days, 'words' => $_->l('дня|дней|дней'))) ?>
                                        </p>
                                    </td>
                                </tr>
