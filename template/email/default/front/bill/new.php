{s}<?=$_->l('Вам выставлен счет на оплату')?>{/s}
                            ...
                            <table cellpadding="0" cellspacing="0" align="center" width="100%" border="0"
                                ...
                                <tr style="vertical-align: top">
                                    <td style="color:#B8B8C0;line-height:150%;text-align:left; vertical-align: top;padding-top: 0px;padding-right: 30px;padding-bottom: 10px;padding-left: 30px">
                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: left"><?= $_->l('Это уведомление о том, что счет №%id создан %date.', array('id' => $bill->id, 'date' => $bill->end_date)) ?>
                                            <br>
                                            <?= $_->l('Счет №%id', array('id' => $bill->id)) ?>
                                            <br>
                                            <?= $_->l('Сумма: %summ', array('summ' => $bill->total)) ?>
                                            <br>
                                            <?= $_->l('Вы можете просмотреть и оплатить счет перейдя по ссылке ниже:') ?>
                                        </p>
                                    </td>
                                </tr>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <a href="<?= $_->link('bill/' . $bill->id) ?>"
                                                               ...
                                                               style="display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;background-color: #C7702E;color: #ffffff">
                                                                <span style="font-size:16px;line-height:32px;"><span
                                                                        ...
                                                                        data-mce-style="font-size: 14px;"><?= $_->l('Перейти к оплате') ?></span></span>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
