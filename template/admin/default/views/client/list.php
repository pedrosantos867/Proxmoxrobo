                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= $_->link('admin/client/edit-balance/' . $client->id) ?>"
                            class="btn btn-xs btn-default ajax-modal" data-toggle="tooltip" data-placement="top"
                            title="<?=$_->l('Изменить')?>"><span class="glyphicon glyphicon-edit" style="margin: 0"
                                aria-hidden="true"></span></a>
                    </td>
                    <td>
                        <a href="<?= $_->link('admin/client/' . $client->id) ?>"
                            class="btn btn-xs btn-default ajax-modal"><span class="glyphicon glyphicon-cog"
                                aria-hidden="true"></span><?=$_->l('Изменить')?></a>
                        ...
                        <a href="<?= $_->link('admin/client/remove/' . $client->id) ?>"
                            ...
                            data-confirm="<?=$_->l('Вы уверены, что хотите безвозвратно удалить клиента?')?> ">
                            <span class="glyphicon glyphicon-trash" aria-hidden="true"></span><?=$_->l('Удалить')?></a>
                        <a href="<?= $_->link('admin/login-client/' . $client->id) ?>"
                            class="btn btn-xs btn-default "><span class="glyphicon glyphicon-log-in"
                                aria-hidden="true"></span><?=$_->l('Войти')?></a>
                    </td>
                </tr>
                <? } ?>
            </tbody>
