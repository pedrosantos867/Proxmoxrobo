{s}<?=$_->l('Ваш хостинговый аккаунт создан')?>{/s}
                                            ...
                                            <div>
                                                <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center">
                                                    <span style="font-size: 20px; line-height: 24px;">
                                                        <?= $_->l('Уважаемый(ая) %client', array('client' => $client->name)) ?>
                                                        <br/>
                                                        <?= $_->l('Ваш хостинговый аккаунт создан и это письмо содержит всю необходимую информацию для работы с Вашим аккаунтом.') ?>
                                                    </span></p></div>
                                        </div>
                                    </td>
                                </tr>
                                <tr style="vertical-align: top">
                                    <td style="color:#B8B8C0;line-height:150%;text-align:left; vertical-align: top;padding-top: 0px;padding-right: 30px;padding-bottom: 10px;padding-left: 30px">
                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: left">
                                            <?= $_->l('Детальная информация нового аккаунта:') ?> <br>
                                            <?= $_->l('Адрес хостинг панели:') ?> <?= $link ?> <br>
                                            <?= $_->l('Логин:') ?> <?= $login ?> <br>
                                            <?= $_->l('Пароль:') ?> <?= $pass ?> <br> <br>
                                            <?= $_->l('Доступ к биллинг панели:') ?> <?= $_->link('/') ?>
                                        </p>
                                    </td>
                                </tr>
